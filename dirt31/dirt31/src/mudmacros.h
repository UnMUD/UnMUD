...
#define pclrflg(C, V)		clr_bit(&pflags(C),(V))
#define psetflg(C, V)		set_bit(&pflags(C),(V))
#define ptstflg(C, V)		tst_bit(&pflags(C),(V))
...
#define pclrmsk(C, V)		clr_bit(&pmask(C),(V))
#define psetmsk(C, V)		set_bit(&pmask(C),(V))
#define ptstmsk(C, V)		tst_bit(&pmask(C),(V))
...
#define sclrflg(C, V)		xclrbit(sflags(C),(V))
#define ssetflg(C, V)		xsetbit(sflags(C),(V))
#define ststflg(C, V)		xtstbit(sflags(C),(V))
...
#define lclrflg(L, V)		xclrbit(xlflags(L),(V))
#define lsetflg(L, V)		xsetbit(xlflags(L),(V))
#define ltstflg(L, V)		xtstbit(xlflags(L),(V))
...
#define otstbit(O, V)		xtstbit(obits(O),(V))
#define oclrbit(O, V)		xclrbit(obits(O),(V))
#define osetbit(O, V)		xsetbit(obits(O),(V))

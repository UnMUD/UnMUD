...
protected:
  ...
  // This is the amount of time in seconds that the manager allows for a socket
  // to successfully send data before it is forcibly closed.
  int m_sendtimeout;
...
// ------------------------------------------------------------------------
template <typename protocol, typename defaulthandler>
void ConnectionManager<protocol, defaulthandler>::NewConnection(
    DataSocket &p_socket) {

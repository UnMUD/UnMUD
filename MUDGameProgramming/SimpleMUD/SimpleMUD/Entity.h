...
public:
  ...
  // --------------------------------------------------------------------
  inline string CompName() const { return BasicLib::LowerCase(m_name); }
...
struct matchentityfull {
  matchentityfull(const string &p_str) : m_str(p_str) { /* do nothing */
  }
...
struct matchentity {
  matchentity(const string &p_str) : m_str(p_str) { /* do nothing */
  }

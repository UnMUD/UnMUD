Current commands :
	...
	imudlist-- get a list of connected muds
		itell user @mud-- send a message to a user at another
		mud(note
			: just saying user @mud works now
				as well)
			igossip message-- send a message over the gossip line
	iwho mud-- find out who's on a mud ilocate name-- find someone
	...
	Note : with itell and igossip,
		   putting a : at the beginning of your text
